...
** Goal
   ...
   Use =Emacs= as the only interface to perform
   =INPUT-TRANSFORM-OUPUT= cycles, i.e, provide
   a dynamic bridge between - the human mind and
