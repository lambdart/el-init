...
* VLM
  ...
  Lisp Machines users are Lisp developers, this is so intrinsically
  true as human knowledge is forgotten in time, time to be free
  on the wind friend, time to be free...
