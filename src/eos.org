...
*** Load-path
    ...
    Uses ~subdirs.el~ and =export EMACSLOADPATH=$EMACSLOADPATH:=.
        ...
        (lambda ()
          ...
          (let ((minibuffer (active-minibuffer-window)))
            (when minibuffer
              ...
              (safe-funcall 'minibuffer-keyboard-quit)))))
...
***** Functions
      ...
      (defun eos/dashboard/open-buffer ()
        ...
        (interactive)
        (safe-funcall 'dashboard-insert-startupify-lists)
...
** Trash
   ...
   Reminder: To add more junk to this shit,
   edit the ~emacs.d/site-lisp/trash/trash.el~.
