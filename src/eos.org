...
***** Hooks
      ...
      (add-hook 'window-setup-hook
                (lambda()
                  (set-wallpaper
                   "~/media/images/wallpapers/studio-ghibli/zelda.png"
                   "-g -0+70")))
      ...
      (defun eos-update-packages-autoloads ()
        ...
        (let ((lisp-dir (expand-file-name "lisp/" user-emacs-directory))
          ...
          (update-packages-autoloads
           lisp-dir (concat lisp-dir "lisp-loaddefs.el"))
          ;; update site-lisp autolods
          (update-packages-autoloads
           site-lisp-dir (concat site-lisp-dir "site-lisp-loaddefs.el"))))
