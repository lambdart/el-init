...
**** Enable
     ...
     (safe-funcall 'size-indication-mode 1)))
...
***** Binds
      ...
      (define-key ctl-x-map (kbd "<end>")
        (lambda ()
          (interactive)
          (safe-start-process "slock" "slock")))
...
***** Binds
      ...
      (global-set-key (kbd "<print>")
                      (lambda ()
                        (interactive)
                        (safe-start-process "scrot" "scrot")
...
***** Binds
      ...
      (define-key eos-completion-map (kbd "g") 'company-gtags)
...
***** Enable
      ...
      ;; enable globally
      (safe-funcall 'global-company-mode 1)
...
*** Adapt
   ...
   (safe-load-file (expand-file-name "adapt.el" user-emacs-directory))
