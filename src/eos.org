...
**** Binds
     ...
     (define-key ctl-x-map (kbd "RET") 'eos-media-map) ;
...
***** Binds
      ...
      (define-key completion-list-mode-map (kbd "ESC") 'force-minibuffer-exit)
...
***** Binds
      ...
      ;; binds eos-media-map
      (define-key eos-media-map (kbd "RET") 'emms-pause)
...
***** Customize
      ...
      (customize-set-variable 'rcirc-default-quit-reason "oops...")
      ...
      (customize-set-variable 'rcirc-server-alist
                              '(("chat.freenode.net"
                                 ...
                                 :encryption tls
                                 :nick "esac"
                                 :channels ("#emacs #emacs-berlin #freebsd"))))
...
***** Functions
      ...
      (defun eos-complete-in-buffer-or-indent ()
        ...
        (interactive)
        (cond ((looking-at "\\_>")
          (safe-funcall 'company-complete-common nil))
         (t (indent-according-to-mode))))
...
** Lab
   ...
   To add more experiments to this configuration
   edit ~emacs.d/lisp/lab/lab.el~ and reload it:
   =M-x load-library RET lab RET=.
