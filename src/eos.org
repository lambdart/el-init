...
*** Header
    ...
    ;;; EOS --- eos.org: an org-mode based Elisp distribution
    ;;
    ;;; Commentary:
...
***** Customize
      ...
      ;; %n nick, %s server, %t target, a channel or a user
      (customize-set-variable 'rcirc-prompt " » ")
