...
**** Enable
     ...
     (add-hook 'window-setup-hook
               (lambda ()
                 (safe-set-frame-font "Iosevka Fixed-15:width=regular:weight=regular")))
...
***** Customize
      ...
      (customize-set-variable 'completion-styles
                              '(partial-completion flex substring initials basic))
      ...
      (eval-after-load 'icomplete
        (lambda ()
          (when (boundp 'icomplete-minibuffer-map)
            ...
            ;; (define-key icomplete-minibuffer-map (kbd "RET") nil)
...
***** Aliases
      ...
      (defalias 'unload-library 'unload-feature)
...
***** Aliases
      ...
      (defalias 'find-subdirectories 'find-lisp-find-dired-subdirectories)
...
***** Customize
      ...
      (customize-set-variable 'lazy-run-idle-flag t)

      ;; idle timer value
      (customize-set-variable 'lazy-idle-seconds 4)
...
***** Aliases
      ...
      ;; yasnippet insert snippet alias
      (defalias 'insert-snippet 'yas-insert-snippet)

      ;; yasnippet find snippet alias
      (defalias 'find-snippet-file 'yas-visit-snippet-file)
...
***** Alias
      ...
      (defalias 'compile-project 'projectile-compile-project)
      (defalias 'find-project-file 'projectile-find-file)
      (defalias 'switch-to-project 'projectile-switch-project)
      ;; (defalias 'switch-to-project-buffer 'projectile-switch-to-buffer)
      ;; (defalias 'switch-to-open-project 'projectile-switch-open-project)
