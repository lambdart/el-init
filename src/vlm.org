...
**** Cmake-ide
     ...
     functionality provided by other packages such as: On the fly
     syntax checks with flycheck auto-completion using
     auto-complete-clang or company-clang. Jump to definition and
     refactoring with rtags.
      ...
      (eval-after-load 'elisp-mode
        (lambda ()
          (when (boundp 'emacs-lisp-mode-map)
            ...
            (define-key emacs-lisp-mode-map (kbd "TAB") 'complete-at-point-or-indent))))
