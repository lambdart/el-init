...
***** Binds
      ...
      ;; ctl-x-map
      ;; (define-key ctl-x-map (kbd "e") 'eval-command-history)
...
***** Customize
      ...
      (customize-set-variable 'icomplete-prospects-height 2)
...
****** Hooks
       ...
       ;; hook run after the term buffer is killed.
...
***** Customize
      ...
      (customize-set-variable 'rcirc-server-alist
                              '(("irc.freenode.net"
                                 ...
                                 :encryption tls
                                 :nick "esac"
                                 :channels ("#rcirc #emacs #lisp-br #emacs-br"))))
...
***** Customize
      ...
      ;; url of the blog.
      (customize-set-variable
       'org-weblog-url "https://esac-io.github.io/")
...
***** Customize
      ...
      ;; set echo delay
      (customize-set-variable 'company-echo-delay .1)

      ;; idle delay in seconds until completion starts automatically
      (customize-set-variable 'company-idle-delay nil)

      ;; maximum number of candidates in the tooltip
      (customize-set-variable 'company-tooltip-limit 9)

      ;; set minimum prefix length
      (customize-set-variable 'company-minimum-length 4)
      ...
      (eval-after-load 'company
        (lambda ()
          (when (boundp 'company-active-map)
            ...
            (define-key company-active-map (kbd "M-DEL") 'company-select-previous)
