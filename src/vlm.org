...
**** Enable
     ...
     (add-hook 'after-make-frame-functions
               (lambda (frame)
                 (safe-set-frame-font "Iosevka:pixelsize=22:width=regular:weight=regular")))

     ;; -PfEd-unscii-thin-normal-normal-*-*-*-*-*-m-0-iso10646-1
...
***** Customize
      ...
      (customize-set-variable 'Info-directory-list
                              `("/usr/local/share/emacs/info/"
                                ...
                                ,(expand-file-name "info/gcl" user-emacs-directory)))
