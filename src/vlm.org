...
**** Customize
     ...
     (customize-set-variable 'gcmh-verbose t)
...
***** Binds
      ...
      (define-key ctl-x-map (kbd "C-c") 'compile-command-history)
      ...
      (eval-after-load 'icomplete
        (lambda ()
          (when (boundp 'icomplete-minibuffer-map)
            ...
            (define-key icomplete-minibuffer-map (kbd "M-SPC") 'icomplete-backward-completions)
...
***** Customize
      ...
      ;; idle timer value
      (customize-set-variable 'lazy-idle-seconds 30) ; half minute
...
***** Customize
      ...
      (customize-set-variable 'rcirc-prompt "%s%t ] ")
      ...
      (customize-set-variable 'rcirc-server-alist
                              '(("chat.freenode.net"
                                 ...
                                 :encryption tls
                                 :nick "esac"
                                 :channels ("#emacs #emacs-br #freebsd"))))
