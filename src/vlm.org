...
**** Enable
     ...
     ;; set frame font
     ;; (safe-set-frame-font "Hermit:pixelsize=20:slant=normal:width=normal:weight=light")))
     (add-hook 'after-make-frame-functions
               (lambda (frame)
                 (safe-set-frame-font "Iosevka Term:pixelsize=20:slant=normal:width=regular:weight=normal")))
...
***** Binds
      ...
      (define-key global-map (kbd "C-M-I") 'yas-insert-snippet)
...
***** Customize
      ...
      (customize-set-variable 'emms-source-file-default-directory
                              (expand-file-name "/storage/media/music"))
...
***** Customize
      ...
      ;; whether to fontify certain ambiguous constructs by white space asymmetry
      (customize-set-variable 'c-asymmetry-fontification-flag t)
