...
***** Customize
      ...
      (customize-set-variable 'read-buffer-completion-ignore-case nil)
      ...
      ;; (customize-set-variable 'completion-at-point-functions `(elisp-completion-at-point
                               ...
                               `((,(kbd "s-q") . exwm-input-toggle-keyboard)
                                 ...
                                 ,@(mapcar (lambda (i)
                                             `(,(kbd (format "s-%d" i)) .
                                               (lambda ()
                                                 (interactive)
                                                 (safe-funcall 'switch-to-tab-by-index ,i))))
                                           (number-sequence 1 (safe-funcall 'tab-bar-number)))))
...
***** Binds
      ...
      (define-key vlm-completion-map (kbd "<tab>") 'ace-complete)
