...
***** Customize
      ...
      (customize-set-variable 'icomplete-delay-completions-threshold 1024)
...
***** Hooks
      ...
      ;;               (dolist (i (number-sequence 1 (safe-funcall 'tabs-number)))
      ;;                 (push `(,(kbd (format "s-%d" i)) .
      ;;                          (lambda ()
      ;;                            (interactive)
      ;;                            (safe-funcall 'tabs-switch-tab-by-index ,i)))
...
****** Customize
       ...
       (customize-set-variable 'exwm-input-global-keys
                               `((,(kbd "s-q") . exwm-input-toggle-keyboard)
                                 ;; switch to tabs (TODO: moves to tabs-bar)
                                 ,@(mapcar (lambda (i)
                                             `(,(kbd (format "s-%d" i)) .
                                               (lambda ()
                                                 (interactive)
                                                 (safe-funcall 'tabs-switch-tab-by-index ,i))))
                                           (number-sequence 1 (safe-funcall 'tabs-number)))))
