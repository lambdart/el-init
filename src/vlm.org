...
***** Binds
      ...
      (define-key ctl-x-map (kbd "C-<f4>") 'shell-command-history)
...
***** Customize
      ...
      (customize-set-variable 'tramp-completion-reread-directory-timeout 15)
      ...
      ;;                         (ignore-errors
      ;;                           (symbol-value 'shell-prompt-pattern)))
...
***** Customize
      ...
      (customize-set-variable 'completion-styles
                              '(basic orderless partial-completion initials))
...
***** Binds
      ...
      (eval-after-load 'mod-selector
        (lambda ()
          (global-set-key (kbd "M-x") 'mod-selector-execute-extended-command)))
...
***** Binds
      ...
      (define-key vlm-pm-map (kbd "d") 'projectile-dired)
